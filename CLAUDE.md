# GOPNIK web port — development guide for Claude
...
└── .claude/launch.json     preview-server config (port 8000)
```
...
```bash
# Start the static server (also auto-started by Claude Preview)
